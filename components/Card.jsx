...
const Card = ({ icon, stat, orta, asagi }) => {
  const icons = {
  ...
  return (
    <div className="-mt-2 p-2 w-[350px] lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0 cursor-pointer md:flex md:flex-nowrap rounded-2xl flex flex-col justify-center items-center">
      <div className="h-[350px] w-[350px] md:w-full md:flex flex justify-center items-center placeholder:first:group rounded-2xl bg-red-200 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16 hover:bg-blue-400 hover:text-slate-100 transition-all duration-500 shadow-2xl">
        <div className="flex flex-col mx-auto max-w-xs px-8 w-[260px] flex-wrap">
          ...
          <div className="mt-6 flex items-baseline justify-center gap-x-2">
            <p className="text-5xl font-normal tracking-tight text-gray-900">
              <a href="#" className="material-symbols-outlined text-xl border-black group-hover:bg-white group-hover:text-blue-500 hover:border-b-2   group-hover:rounded-full transition-all duration-500">
                {ortas[orta]}
              </a>
            </p>
          </div>
          ...
          <div className="mt-20">
          <a href="#" className="m-automt-10 block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-2xl hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 font-turan uppercase">Ətralı</a>
          </div>
