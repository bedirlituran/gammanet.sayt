  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full cursor-pointer group">
      ...
      <button
        ...
        text-lg  absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center  font-bold  z-50 group-hover:block   transition-all duration-500 shadow-2xl">
        Sifariş Et
      </button>
    </div>
  );
